import { Flex, Heading, Section, Text, Box, Button } from "@radix-ui/themes"
        ...
        <Section  className='bg'>
            <Flex pt={"0"} pb={"4"} direction={"column"} align={"center"}>
                ...
                <Flex pt={"5"} direction={"row"} gap={"4"} justify={"center"}>
                    <Button color="iris" size={{initial:"1", sm:"2"}}>React</Button>
                    <Button color="violet" size={{initial:"1", sm:"2"}}>Node,js</Button>
                    <Button color="purple" size={{initial:"1", sm:"2"}}>Java</Button>
                    <Button color="pink" size={{initial:"1", sm:"2"}}>Python</Button>
                </Flex>
